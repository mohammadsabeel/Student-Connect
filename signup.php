                    ...
                    <div class="col-sm-6 offset-sm-6 text-center">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="mail" placeholder="Email" pattern="[a-zA-Z0-9._%+-]+\.is21@rvce\.edu\.in" title="Enter your RVCE email ID: rhythmkishore.is21@rvce.edu.in" required>
