				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						...
						<ul class="social-icons">
							<li><a href="https://github.com/KanhaiyaDutta" target="_blank">
        ...
        <section class="content-section" id="portfolio">
          <div class="container">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://github.com/KanhaiyaDutta" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
              ...
              <div class="col-lg-6">
                <a class="portfolio-item" href="https://github.com/KanhaiyaDutta">
                  <span class="caption">
                    <span class="caption-content">
                      <h2>KLiK</h2>
